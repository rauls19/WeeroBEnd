...
## For developers
- install golang [[Reference](https://golang.org/doc/install)]
### Local
...
- Use go run to execute the project [[Reference](https://golang.org/cmd/go/#hdr-Compile_and_run_Go_program)]
